...
public class MainTest {
	public static void main(String[] args) {
		...
		// Staff staff = new Staff("Danh", "Ho", "Cong", "TG", new Timestamp(new
		// Date().getTime()), 1000, "USD");
		// Staff created = staffService.saveOrUpdate(staff);
		// System.out.println("created : " + created);

		Staff find = staffService.findById(10);
		find.setFirstName("Danh Danh " + 11);
		System.out.println("created : " + staffService.saveOrUpdate(find));
	}
}
