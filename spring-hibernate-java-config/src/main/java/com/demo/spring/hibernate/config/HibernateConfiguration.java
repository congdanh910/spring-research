package com.demo.spring.hibernate.config;
...
@ComponentScan({"com.demo.spring.hibernate"})
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[]{"com.demo.spring.hibernate.model"});
